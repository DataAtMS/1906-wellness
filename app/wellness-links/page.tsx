import { wellnessLinks } from "@/lib/links";
import { WELLNESS_LINKS_TAGLINE } from "@/lib/taglines";
import { SITE_LAST_UPDATED } from "@/lib/meta";

export const metadata = {
  title: "Health and Wellness Resource Links",
  description:
    "Curated outbound links to government health agencies, academic medical centers, and wellness publications.",
};

export default function WellnessLinksPage() {
  const total = wellnessLinks.reduce((n, s) => n + s.items.length, 0);
  return (
